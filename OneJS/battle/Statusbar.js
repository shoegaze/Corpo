...
var Statusbar = function (_a) {
    ...
    var _b = (0, onejs_1.useEventfulState)(battleUI, 'Mode'), mode = _b[0], _0 = _b[1];
    var _c = (0, onejs_1.useEventfulState)(battleUI, 'Team'), team = _c[0], _1 = _c[1];
    var _d = (0, onejs_1.useEventfulState)(battleUI, 'Turn'), turn = _d[0], _2 = _d[1];
