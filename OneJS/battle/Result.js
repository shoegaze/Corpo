...
var Result = function (_a) {
    ...
    var _b = (0, onejs_1.useEventfulState)(battleView, 'DoAlliesWin'), doAlliesWin = _b[0], _0 = _b[1];
    var _c = (0, onejs_1.useEventfulState)(battleView, 'DoEnemiesWin'), doEnemiesWin = _c[0], _1 = _c[1];
